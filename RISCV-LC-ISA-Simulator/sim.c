...
void handle_srai(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = MASK24_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = sext(CURRENT_LATCHES.REGS[rs1] >> imm12,5);
...
void handle_lui(unsigned int cur_inst) {
    ...
    int imm = MASK31_12(cur_inst);
    NEXT_LATCHES.REGS[rd] = imm << 12;
...
void handle_sra(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst),
        rs1 = MASK19_15(cur_inst),
        rs2 = MASK24_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = sext(CURRENT_LATCHES.REGS[rs1] >> CURRENT_LATCHES.REGS[rs2],5);
...
void handle_jal(unsigned int cur_inst) {
     ...
     */
    unsigned int rd = MASK11_7(cur_inst);
    int imm20 = sext((MASK31(cur_inst) <<20) + (MASK30_21(cur_inst) << 1) + (MASK20(cur_inst) << 11) + (MASK19_12(cur_inst) << 12),20);
    NEXT_LATCHES.REGS[rd] = CURRENT_LATCHES.PC + 4;
...
void handle_lw(unsigned int cur_inst) {
    ...
    unsigned int rd = MASK11_7(cur_inst), rs1 = MASK19_15(cur_inst);
    int imm12 = MASK31_20(cur_inst);
    NEXT_LATCHES.REGS[rd] = sext(MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]] + (MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+1]<<8) + (MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1]+2]<<16) + (MEMORY[sext(imm12, 12) + CURRENT_LATCHES.REGS[rs1] + 3]<<24),32);
...
void handle_sb(unsigned int cur_inst) {
     ...
     */
    unsigned int rs1 = MASK19_15(cur_inst), rs2 = MASK24_20(cur_inst);
    int imm12 = (sext(MASK31_25(cur_inst),7) <<5 )+ sext(MASK11_7(cur_inst),5) ;
...
void handle_sh(unsigned int cur_inst) {
    ...
    MEMORY[CURRENT_LATCHES.REGS[rs1]+sext(imm12,12)+1]= MASK15_8(CURRENT_LATCHES.REGS[rs2]);
...
void handle_sw(unsigned int cur_inst) {
    ...
    MEMORY[CURRENT_LATCHES.REGS[rs1]+sext(imm12,12)]= MASK7_0(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[CURRENT_LATCHES.REGS[rs1]+sext(imm12,12)+1]= MASK15_8(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[CURRENT_LATCHES.REGS[rs1]+sext(imm12,12)+2]= MASK23_16(CURRENT_LATCHES.REGS[rs2]);
    MEMORY[CURRENT_LATCHES.REGS[rs1]+sext(imm12,12)+3]= MASK31_24(CURRENT_LATCHES.REGS[rs2]);
